...
export const geofenceConfig = {
  ...
  checkinRadiusMeters: parseNumber(env.CHECKIN_RADIUS_METERS, 80),
  checkoutRadiusMeters: parseNumber(env.CHECKOUT_RADIUS_METERS, 150),
  maxAccuracyMeters: parseNumber(env.MAX_ACCURACY_METERS, 35),
  locationMaxAgeSeconds: parseNumber(env.LOCATION_MAX_AGE_SECONDS, 45),
